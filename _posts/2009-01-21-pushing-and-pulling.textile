...
Se você está começando com GIT, você pode pensar que isto é muito elevado e leva a uma falha de controle. Mas olhe por esse lado: se o seu servidor central cair, você geralmente está na mão, impedido de trabalhar e colaborar com os outros. Uma vez que todos os envolvidos com o projeto tem uma revisão em sua própria máquina, você pode codificar mesmo se a rede cair, se não tiver autorização de outros ou quando esta sujeito a problemas de rede. Eu já comentei que isto é muito mais rápido para a maioria das operações comuns? Confira mais algumas das vantagens (e desvantagens) do DVCS na "Wikipédia":http://en.wikipedia.org/wiki/Distributed_revision_control#Vs_Centralised.
